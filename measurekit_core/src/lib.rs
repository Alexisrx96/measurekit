...
impl UnitRegistry {
    ...
    /// Adds a new base unit (e.g., "meter").
    ...
    /// Adds a derived unit defined in terms of other units.
...
/// A lightweight carrier for a value and its unit.
#[pyclass]
#[derive(Clone)]
...
impl QuantityInner {
    #[new]
    fn new(value: f64, unit: RationalUnit) -> Self {
        QuantityInner { value, unit }
    }
}
