# measurekit/ext/io.py
"""Scientific Serialization module for MeasureKit."""
...
def to_hdf5(quantity: Quantity, group: Group, dataset_name: str) -> Dataset:
    ...
    ds.attrs["measurekit_version"] = __version__
...
if xr is not None:
    ...
    @xr.register_dataarray_accessor("measurekit")
    class MeasureKitAccessor:
        """Xarray accessor for MeasureKit integration."""

        def __init__(self, xarray_obj: xr.DataArray):
            self._obj = xarray_obj

        def quantify(self, unit: str | None = None) -> Quantity:
            """Converts the DataArray to a MeasureKit Quantity.
