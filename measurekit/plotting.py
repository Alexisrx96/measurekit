"""Visualization and plotting utilities for MeasureKit physical quantities.
...
def plot(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        theme: Style theme to apply (defaults to 'measurekit' clean style).
    ...
    if theme == "measurekit" and kind != "slices" and kind != "surface":
...
def plot_slices(
    ...
    **kwargs: Any,
    ...
    if not isinstance(quantity, Quantity):
        raise TypeError("plot_slices requires a measurekit Quantity.")
...
def plot_interactive(
    ...
    **kwargs: Any,
    ...
    if not isinstance(quantity, Quantity):
        raise TypeError("plot_interactive requires a measurekit Quantity.")
