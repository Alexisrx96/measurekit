...
pub fn start_web_server(title: &str, code: &str, steps: &[ExecutionStep], vars: &HashMap<String, PhsValue>) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let paper_inst = meta.institution.clone().unwrap_or_else(|| "Physure Live Visualizer".to_string());
...
<head>
    ...
    <title>{} &mdash; Physure Visualizer</title>
...
<body>
    <div class="paper-manuscript">
        ...
        <header class="paper-header">
            ...
            <div class="paper-author-meta">{} &bull; {} &bull; Motor Physure Live</div>
        </header>
